  ...
  <div class="container-fluid py-2">
    <div class="row">
      <div class="col-12 px-4">
        <h3 class="mb-3 h4 fw-bold">Dashboard</h3>
      ...
      <div class="row align-items-center justify-content-between">
        ...
        <div class="col-md-6">
          <ul class="nav justify-content-center justify-content-md-end">
            <li class="nav-item">
              <a class="nav-link text-muted px-2" href="https://www.creative-tim.com" target="_blank">Creative Tim</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-muted px-2" href="https://www.creative-tim.com/presentation" target="_blank">About Us</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-muted px-2" href="https://www.creative-tim.com/blog" target="_blank">Blog</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-muted px-2" href="https://www.creative-tim.com/license" target="_blank">License</a>
            </li>
          </ul>
        </div>
      </div>
