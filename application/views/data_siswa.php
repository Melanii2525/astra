...
<body>
  ...
  <div class="container py-5">
    ...
    <!-- Table -->
      ...
      <input type="text" id="searchInput" class="form-control w-25" placeholder="Cari nama / kelas / wali kelas..." oninput="this.value = this.value.toUpperCase()">
...
function cariData(page = 1) {
  $.ajax({
    ...
    data: { keyword: searchKeyword, page: page },
    dataType: "json",
    success: function (res) {
      renderTable(res.siswa);
