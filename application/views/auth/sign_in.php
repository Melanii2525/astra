...
<head>
  ...
  <title>ASTRA Selapan - Login</title>
            ...
            <div class="col-lg-4 col-md-8 col-12 mx-auto">
              <div class="card z-index-0 fadeIn3 fadeInBottom mt-8">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                  <div class="shadow-dark border-radius-lg py-3 pe-1 text-center" style="background-color: #2C6A74;">
                    <h4 class="text-white font-weight-bolder m-0">Login</h4>
                  </div>
                </div>
